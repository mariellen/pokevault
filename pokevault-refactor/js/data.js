...
const FORM_DROPDOWNS = {
  ...
  Pikachu: [
    'Unknown', 'Adventure Hat', 'Akari Kerchief', 'Anniversary 2017', 'Aquamarine Crown',
    'Ash Hat', 'Batik Shirt', 'Beanie', 'Blue Shirt Citrus', 'Brendan Hat', 'Cake', 'Cap Hat',
    'Charizard Hat', 'Cherry Blossom', 'Clone', 'Dapper Blue', 'Dapper Red', 'Dapper Yellow',
    'Dawn Hat', 'Detective', 'Detective 2023', 'Diamond Crown', 'Explorer Hat', 'Fall 2023',
    'Flower Crown', 'Flower Hat', 'Flying', 'Flying 5th Anniversary', 'Flying Black',
    'Flying Green', 'Flying Orange', 'Flying Pink', 'Flying Plain Balloons', 'Formal Blue',
    'Formal Red', 'Formal Yellow', 'Fragment Hat', 'GO Fest Goggles Blue',
    'GO Fest Goggles Red', 'GO Fest Goggles Yellow', 'GO Tour 2024 A', 'GO Tour 2024 B',
    'GO Tour 2026 A', 'GO Tour 2026 B', 'Gracidea Flower', 'Green Shirt', 'Halloween 2017',
    'Halloween Mischief', 'Hilbert Hat', 'Hilda Hat', 'Holiday', 'Indonesia Football',
    'Kariyushi', 'Kurta', 'Lucario Hat', 'Lucas Hat', 'Lyra Hat', 'Malachite Crown',
    ...
    'Umbreon Hat', 'Varsity Jacket', 'Winter Holiday 2023', 'World Cap 2022', 'World Cap 2023',

...
const FORM_DROPDOWNS = {
  ...
  Pikachu: [
    ...
    'Cake', 'Calem Hat', 'Cap Hat', 'Charizard Hat', 'Cherry Blossom', 'Clone', 'Dapper Blue', 'Dapper Red',
    ...
    'Indonesia Football', 'Kariyushi', 'Kurta', "Leaf's Hat", 'Lucario Hat', 'Lucas Hat', 'Lyra Hat',
    ...
    'Quartz Crown', 'Rayquaza Hat', "Red's Hat", 'Rei Cap', 'Rock Star', 'Rosa Visor', 'Safari Cap',
  ...
  Pichu:  ['Unknown', 'None', 'Cherry Blossom', 'Fragment Hat', 'Meloetta Hat', 'Party Hat Red', 'Santa Hat', 'Witch Hat'],
